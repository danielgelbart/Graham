...
Stock.create( 'name'=>'Tesoro Corporation','ticker'=>'ANDV','cik'=>50104,'fyed'=>'12-31')
...
Stock.create( 'name'=>'Walgreens Boots Alliance, Inc.','ticker'=>'WBA','cik'=>1618921,'fyed'=>'08-31')
...
Stock.create( 'name'=>'Anthem, Inc.','ticker'=>'ANTM','cik'=>1156039,'fyed'=>'12-31')
...
Stock.create( 'name'=>'Willis Towers Watson PLC','ticker'=>'WLTW','cik'=>1140536,'fyed'=>'12-31')
...
Stock.create( 'name'=>'Zimmer Biomet Holdings, Inc.','ticker'=>'ZBH','cik'=>1136869,'fyed'=>'12-31')
...
#updates done Jan 2016
Stock.create( 'name'=>'AbbVie Inc.','ticker'=>'ABBV','cik'=>1551152,'fyed'=>'12-31')
Stock.create( 'name'=>'ADT Corp','ticker'=>'ADT','cik'=>1546640,'fiscal_year_end'=>'09-30')
Stock.create( 'name'=>'ALEXION PHARMACEUTICALS INC','ticker'=>'ALXN','cik'=>899866,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'Allegion plc','ticker'=>'ALLE','cik'=>1579241,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'Avago Technologies LTD','ticker'=>'AVGO','cik'=>1441634,'fiscal_year_end'=>'10-31')
Stock.create( 'name'=>'Baxalta Inc','ticker'=>'BXLT','cik'=>1620546,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'HENRY SCHEIN INC','ticker'=>'HSIC','cik'=>1000228,'fiscal_year_end'=>'12-29')
Stock.create( 'name'=>'CERNER CORP','ticker'=>'CERN','cik'=>804753,'fiscal_year_end'=>'01-02','fy_same_as_ed'=>false)
Stock.create( 'name'=>'Columbia Pipeline Group, Inc','ticker'=>'CPGX','cik'=>1629995,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'CSRA Inc','ticker'=>'CSRA','cik'=>1646383,'fiscal_year_end'=>'04-01')
Stock.create( 'name'=>'Delphi Automotive PLC','ticker'=>'DLPH','cik'=>1521332,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'Discovery Communications, Inc.','ticker'=>'DISCK','cik'=>1437107,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'DOLLAR TREE INC','ticker'=>'DLTR','cik'=>935703,'fiscal_year_end'=>'01-31','fy_same_as_ed'=>false)
Stock.create( 'name'=>'Endo International plc, Inc.','ticker'=>'ENDP','cik'=>1593034,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'Ensco plc','ticker'=>'ESV','cik'=>314808,'fiscal_year_end'=>'12-31')
...
Stock.create( 'name'=>'WestRock Co','ticker'=>'WRK','cik'=>1636023,'fiscal_year_end'=>'12-30')
Stock.create( 'name'=>'Monster Beverage Corp', 'ticker'=>'MNST','cik'=>865752,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'NAVIENT CORP', 'ticker'=>'NAVI','cik'=>1593538,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'NETFLIX INC', 'ticker'=>'NFLX','cik'=>1065280,'fiscal_year_end'=>'12-31')
...
Stock.create( 'name'=>'Synchrony Financial', 'ticker'=>'SYF','cik'=>1601712,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'TRACTOR SUPPLY CO', 'ticker'=>'TSCO','cik'=>916365,'fiscal_year_end'=>'12-27')
...
Stock.create('name'=>'Quintiles IMS Holdings, Inc.','ticker'=>'IQV','cik'=>1478242,'fiscal_year_end'=>'12-31')
Stock.create('name'=>'Brighthouse Financial, Inc.','ticker'=>'BHF','cik'=>1685040,'fiscal_year_end'=>'12-31')
Stock.create('name'=>'CADENCE DESIGN SYSTEMS INC','ticker'=>'CDNS','cik'=>813672,'fiscal_year_end'=>'12-28')
Stock.create( 'name'=>'DowDuPont Inc.','ticker'=>'DWDP','cik'=>1666700,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'SBA COMMUNICATIONS CORP','ticker'=>'SBAC','cik'=>1034054,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'Norwegian Cruise Line Holdings Ltd.','ticker'=>'NCLH','cik'=>1513761,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'Arista Networks, Inc.','ticker'=>'ANET','cik'=>1596532,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'Booking Holdings Inc.','ticker'=>'BKNG','cik'=>1075531,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'COPART INC','ticker'=>'CPRT','cik'=>900075,'fiscal_year_end'=>'07-31')
Stock.create( 'name'=>'Evergy, Inc.','ticker'=>'EVRG','cik'=>1711269,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'HollyFrontier Corp','ticker'=>'HFC','cik'=>48039,'fiscal_year_end'=>'12-31')
Stock.create( 'name'=>'IPG PHOTONICS Corp','ticker'=>'IPGP','cik'=>1111928,'fiscal_year_end'=>'12-31')
